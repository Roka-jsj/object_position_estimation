...
def generate_launch_description():
    ...
    def run_yolo(context: LaunchContext, use_tracking, use_3d):
        ...
        model_cmd = DeclareLaunchArgument(
            "model",
            default_value="/ros2_ws/src/yolo_ros/yolo_ros/model/wooden_cube.pt",
        ...
        throttle_node_cmd = Node(
            package="topic_tools",
            executable="throttle",
            name="dbg_image_throttle",
            arguments=["messages", "/yolo/dbg_image", "1.0", "/yolo/photo"],
        )
